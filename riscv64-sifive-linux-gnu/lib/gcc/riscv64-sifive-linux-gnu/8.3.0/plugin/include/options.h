...
enum opt_code
{
  ...
  OPT_mdiv = 1195,                           /* -mdiv */
  OPT_mexplicit_relocs = 1196,               /* -mexplicit-relocs */
  OPT_mfdiv = 1197,                          /* -mfdiv */
  OPT_mglibc = 1198,                         /* -mglibc */
  OPT_mmusl = 1199,                          /* -mmusl */
  OPT_mplt = 1200,                           /* -mplt */
  OPT_mpreferred_stack_boundary_ = 1201,     /* -mpreferred-stack-boundary= */
  OPT_mrelax = 1202,                         /* -mrelax */
  OPT_msave_restore = 1203,                  /* -msave-restore */
  OPT_msmall_data_limit_ = 1204,             /* -msmall-data-limit= */
  OPT_mstrict_align = 1205,                  /* -mstrict-align */
  OPT_mtune_ = 1206,                         /* -mtune= */
  OPT_muclibc = 1207,                        /* -muclibc */
  OPT_n = 1208,                              /* -n */
  OPT_no_canonical_prefixes = 1209,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1210,              /* -no-integrated-cpp */
  OPT_no_pie = 1211,                         /* -no-pie */
  OPT_nocpp = 1212,                          /* -nocpp */
  OPT_nodefaultlibs = 1213,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1214,                   /* -nostartfiles */
  OPT_nostdinc = 1215,                       /* -nostdinc */
  OPT_nostdinc__ = 1216,                     /* -nostdinc++ */
  OPT_nostdlib = 1217,                       /* -nostdlib */
  OPT_o = 1218,                              /* -o */
  OPT_p = 1219,                              /* -p */
  OPT_pass_exit_codes = 1220,                /* -pass-exit-codes */
  /* OPT_pedantic = 1221, */                 /* -pedantic */
  OPT_pedantic_errors = 1222,                /* -pedantic-errors */
  OPT_pg = 1223,                             /* -pg */
  OPT_pie = 1224,                            /* -pie */
  OPT_pipe = 1225,                           /* -pipe */
  OPT_posix = 1226,                          /* -posix */
  OPT_print_file_name_ = 1227,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1228,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1229,          /* -print-multi-directory */
  OPT_print_multi_lib = 1230,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1231,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1232,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1233,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1234,               /* -print-prog-name= */
  OPT_print_search_dirs = 1235,              /* -print-search-dirs */
  OPT_print_sysroot = 1236,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1237,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1238,                        /* -profile */
  OPT_pthread = 1239,                        /* -pthread */
  OPT_quiet = 1240,                          /* -quiet */
  OPT_r = 1241,                              /* -r */
  OPT_rdynamic = 1242,                       /* -rdynamic */
